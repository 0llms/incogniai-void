...
export const Settings = () => {
	...
	const navItems: { tab: Tab; label: string }[] = [
		...
		{ tab: 'providers', label: 'incogniAI Cloud & Key' },
        ...
        `}
				...
				<main className="flex-1 p-6 select-none">
					...
					<div className='max-w-3xl'>
						...
						<h1 className='text-2xl w-full'>{`IncogniAI IDE Settings`}</h1>
						...
						<div className='flex flex-col gap-12'>
							...
							<div className={shouldShowTab('localProviders') ? `` : 'hidden'}>
								<ErrorBoundary>
									...
									<h3 className={`text-void-fg-3 mb-2`}>{`incogniAI IDE can access any model that you host locally. We automatically detect your local models by default.`}</h3>
							...
							<div className={shouldShowTab('providers') ? `` : 'hidden'}>
								<ErrorBoundary>
									...
									<h3 className={`text-void-fg-3 mb-2`}>{`incogniAI IDE can access models from Anthropic, OpenAI, OpenRouter, and more.`}</h3>
							...
							<div className={`${shouldShowTab('general') ? `` : 'hidden'} flex flex-col gap-12`}>
								...
								<div>
									<ErrorBoundary>
										...
										<h4 className='text-void-fg-3 mb-4'>{`Transfer your editor settings into IncogniAI IDE.`}</h4>
...
Alternatively, place a \`.incogniairules\` file in the root of your workspace.
